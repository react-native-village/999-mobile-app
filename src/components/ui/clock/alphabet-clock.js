  ...
  return (
    <Background>
      <View style={styles.container}>
        <View>
          <Text ibm1>
            {polyColors[27] === STROKE_COLOR
              ? ' '
              : polyColors[26] === STROKE_COLOR
              ? 'Z'
              : polyColors[25] === STROKE_COLOR
              ? 'Y'
              : polyColors[24] === STROKE_COLOR
              ? 'X'
              : polyColors[23] === STROKE_COLOR
              ? 'W'
              : polyColors[22] === STROKE_COLOR
              ? 'V'
              : polyColors[21] === STROKE_COLOR
              ? 'U'
              : polyColors[20] === STROKE_COLOR
              ? 'T'
              : polyColors[19] === STROKE_COLOR
              ? 'S'
              : polyColors[18] === STROKE_COLOR
              ? 'R'
              : polyColors[17] === STROKE_COLOR
              ? 'Q'
              : polyColors[16] === STROKE_COLOR
              ? 'P'
              : polyColors[15] === STROKE_COLOR
              ? 'O'
              : polyColors[14] === STROKE_COLOR
              ? 'N'
              : polyColors[13] === STROKE_COLOR
              ? 'M'
              : polyColors[12] === STROKE_COLOR
              ? 'L'
              : polyColors[11] === STROKE_COLOR
              ? 'K'
              : polyColors[10] === STROKE_COLOR
              ? 'J'
              : polyColors[9] === STROKE_COLOR
              ? 'I'
              : polyColors[8] === STROKE_COLOR
              ? 'H'
              : polyColors[7] === STROKE_COLOR
              ? 'G'
              : polyColors[6] === STROKE_COLOR
              ? 'F'
              : polyColors[5] === STROKE_COLOR
              ? 'E'
              : polyColors[4] === STROKE_COLOR
              ? 'D'
              : polyColors[3] === STROKE_COLOR
              ? 'C'
              : polyColors[2] === STROKE_COLOR
              ? 'B'
              : polyColors[1] === STROKE_COLOR
              ? 'A'
              : ' '}
          </Text>
        </View>
